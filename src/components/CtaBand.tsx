        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              ...
              onClick={() => trackCta(primaryLabel, { cta_location: "cta_band", destination: primaryTo })}
            >
            ...
            {secondary ? (
              <Link
                to={secondary.to}
                onClick={() => trackCta(secondary.label, { cta_location: "cta_band_secondary", destination: secondary.to })}
              ...
              <a
                ...
                onClick={() => trackCta("Call 0726 927 081", { cta_location: "cta_band_phone" })}
                className={`inline-flex items-center justify-center gap-2 px-8 py-4 rounded-md border font-sans text-sm tracking-widest uppercase transition-colors ${
                  dark
                    ? "border-background/40 text-background hover:bg-background/10"
                    : "border-primary/30 text-primary hover:bg-primary/5"
