...
const steps = [
  { n: "01", title: "Send your brief", text: "Two minutes on the form below — destination, dates, travellers, rough budget." },
...
const faqs: Faq[] = [
  ...
  },
  {
    ...
    answer: "Destination or trip idea, travel dates or a rough window, number of travellers and their ages, and a budget band. Anything else — dietary needs, mobility, celebrations — helps us get it right first time.",
  },
  {
  ...
  {
    question: "Do you invoice companies?",
    answer: "Yes. Corporate accounts are set up with consolidated monthly invoicing, cost-centre coding and approved credit terms.",
  },
];
...
const Quote = () => (
  <PageTransition>
    <div className="min-h-screen bg-background">
      ...
      {/* Header */}
      <section className="pt-32 pb-14 px-6 md:px-16 bg-ocean-light">
        <motion.div
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          {reasons.map((item, index) => (
            <motion.div
              ...
              className="flex items-start gap-3 bg-sand-dark p-6 rounded-xl"
            >
              <item.icon className="w-6 h-6 text-primary flex-shrink-0 mt-0.5" strokeWidth={1.6} />
              <div>
                <h2 className="font-display text-lg mb-1">{item.title}</h2>
      ...
      <section className="pb-20 px-6 md:px-16">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-[1.6fr_1fr] gap-10 items-start">
          <div className="bg-card p-8 md:p-12 rounded-xl border border-border shadow-soft">
            <div className="mb-9">
              ...
              <h2 className="font-display text-2xl md:text-3xl mb-3">Request your free quote</h2>
      ...
      <Testimonials
        ...
        heading="People who filled in this same form"
        intro="Corporates, schools, families and honeymooners who started with a two-minute enquiry."
        limit={3}
      />

      <FaqBlock faqs={faqs} eyebrow="Quote FAQs" heading="Questions about enquiring" tone="plain" />
